                ...
                borderData: FlBorderData(
                  ...
                  border: Border(
                    ...
                    BarChartGroupData(x: 0, barRods: [
                      BarChartRodData(toY: 238, color: const Color(0xFF1976D2), width: 24),
                      BarChartRodData(toY: 714, color: const Color(0xFF4CAF50), width: 24),
                      BarChartRodData(toY: 0, color: const Color(0xFF4DD0E1), width: 24),
                    ]),
                    BarChartGroupData(x: 1, barRods: [
                      BarChartRodData(toY: 238, color: const Color(0xFF1976D2), width: 24),
                      BarChartRodData(toY: 96, color: const Color(0xFF4CAF50), width: 24),
                      BarChartRodData(toY: 0, color: const Color(0xFF4DD0E1), width: 24),
                    ]),
                    BarChartGroupData(x: 2, barRods: [
                      BarChartRodData(toY: 550, color: const Color(0xFF1976D2), width: 24),
                      BarChartRodData(toY: 700, color: const Color(0xFF4CAF50), width: 24),
                      BarChartRodData(toY: 750, color: const Color(0xFF4DD0E1), width: 24),
                    ]),
                    BarChartGroupData(x: 3, barRods: [
                      BarChartRodData(toY: 170, color: const Color(0xFF1976D2), width: 24),
                      BarChartRodData(toY: 240, color: const Color(0xFF4CAF50), width: 24),
                      BarChartRodData(toY: 190, color: const Color(0xFF4DD0E1), width: 24),
                    ]),
                    BarChartGroupData(x: 4, barRods: [
                      BarChartRodData(toY: 476, color: const Color(0xFF1976D2), width: 24),
                      BarChartRodData(toY: 238, color: const Color(0xFF4CAF50), width: 24),
                      BarChartRodData(toY: 0, color: const Color(0xFF4DD0E1), width: 24),
                    ]),
                    BarChartGroupData(x: 5, barRods: [
                      BarChartRodData(toY: 0, color: const Color(0xFF1976D2), width: 24),
                      BarChartRodData(toY: 476, color: const Color(0xFF4CAF50), width: 24),
                      BarChartRodData(toY: 572, color: const Color(0xFF4DD0E1), width: 24),
                    ]),
